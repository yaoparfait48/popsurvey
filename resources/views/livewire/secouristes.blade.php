...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="../img/pop.png" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="../img/pop.png" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="../img/g" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-warning navbar-badge p-1">{{$nb_notif}}</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          @this.set('map',false);
            @this.readAlert({{ $al->id }});
          ">
            <i class="fas fa-envelope mr-2"></i> {{ $al->type }} {{ $al->niveau }}
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="../img/pop.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="height:100px;">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a href="#" class="d-block">Utilisateur test</a>
        </div>
      </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Secouriste</li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-4 col-md-2">
                    <h4 class="text-center">Niveau Bas</h4>

                    <div class="color-palette-set">
                      <div class="bg-primary color-palette"><span>#007bff</span></div>
                      <div class="bg-primary disabled color-palette"><span>0</span></div>
                    </div>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-4 col-md-2">
                    <h4 class="text-center">Niveau Semi-moyen</h4>

                    <div class="color-palette-set">
                      <div class="bg-secondary color-palette"><span>#6c757d</span></div>
                      <div class="bg-secondary disabled color-palette"><span>0</span></div>
                    </div>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-4 col-md-2">
                    <h4 class="text-center">Niveau Moyen</h4>

                    <div class="color-palette-set">
                      <div class="bg-info color-palette"><span>#17a2b8</span></div>
                      <div class="bg-info disabled color-palette"><span>0</span></div>
                    </div>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-4 col-md-2">
                    <h4 class="text-center">Niveau Peu-elevé</h4>

                    <div class="color-palette-set">
                      <div class="bg-success color-palette"><span>#28a745</span></div>
                      <div class="bg-success disabled color-palette"><span>0</span></div>
                    </div>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-4 col-md-2">
                    <h4 class="text-center bg-warning">Niveau élévé</h4>

                    <div class="color-palette-set">
                      <div class="bg-warning color-palette"><span>#ffc107</span></div>
                      <div class="bg-warning disabled color-palette"><span>0</span></div>
                    </div>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-4 col-md-2">
                    <h4 class="text-center">Niveau  Très élévé</h4>

                    <div class="color-palette-set">
                      <div class="bg-danger color-palette"><span>#dc3545</span></div>
                      <div class="bg-danger disabled color-palette"><span>0</span></div>
                    </div>
                  </div>
                  <!-- /.col -->
                </div>
                ...
                <div class="row">
                  <div class="col-sm-4 col-md-2">
                    ...
                    <div class="color-palette-set">
                      ...
                      <div class="bg-black disabled color-palette"><span>0</span></div>
                    </div>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-4 col-md-2">
    ...
    @elseif($action == 'read')
      <section class="content p-2">
        <div class="content mt-1">
          <a class="btn btn-primary float-right text-white" onclick="@this.intervation()">Accepter l'intervention</a>
          <a class="btn btn-danger float-left text-white" onclick="@this.set('action','dash')">Retour a tableau de bord</a>
        </div>
        <div class="row">
          <div class="col-md-12" style="text-align: center">
              <img src="../img/alertsign.jpg" style="height: 100px;">
          </div>
          <div class="col-md-12">
            <h3 class="text-danger text-center">Informations sur l'alerte</h3>
          </div>
        </div>
        <div class="card border-danger mb-3 ml-5 mr-5">
          <div class="card-header">ALERTE</div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-8">
                <div class="text-center p-2">
                  <h3>TYPE ALERTE : <b class="text-danger">{{ $alert_select->type }}</b></h3>
                </div>
                <div class="text-center">
                  <h4>NINEAU : {{ $alert_select->niveau }} </h4>
                  <h4>VILLE : {{ $alert_select->ville }}</h4>
                </div>
                  <div class="row">
                    <div class="col-md-3">
                      <h4>Description : </h4>
                    </div>
                    <div class="col-md-9 bg-light rounded pb-5 pt-0">
                      <p>{{ $alert_select->description_alerte }}</p>
                    </div>
                  </div>
                </h4>
              </div>
              <div class="col-md-4">
                <h5>LONGITUDE : {{ $alert_select->longitude }}</h5>
                <h5>LATITUDE : {{ $alert_select->latitude }}</h5>
              </div>
            </div>
          </div>
        </div>
        <div class="container" style="height: 200px !important">
          ...
          @if($map)
            @livewire('map',['latitude' => $alert_select->latitude, 'longitude' => $alert_select->longitude])
          @endif
      </div>
      </section>
    @endif
